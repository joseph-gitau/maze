...
# Maze lay files
# mazeLayFiles = ["maze/bigMaze.lay", "maze/mediumMaze.lay"]
mazeLayFiles = ["maze/bigMaze.lay", "maze/mediumMaze.lay", "maze/openMaze.lay", "maze/sample maze file.lay", "maze/smallMaze.lay", "maze/smallSearch.lay", "maze/tinySearch.lay", "maze/trickySearch.lay"]
